...
export const mockAdminData = {
  ...
  stats: [
    { label: "Órdenes Totales", value: 156 },
    { label: "Órdenes Activas", value: 23 },
    { label: "Clientes", value: 89 },
    { label: "Técnicos", value: 5 },
  ],
  recentActivity: [
    {
      id: 1,
      type: "new_order",
      message: "Nueva orden #TS-2024-001 creada por María González",
      time: "Hace 5 minutos",
      icon: "plus",
    },
    {
      id: 2,
      type: "status_change",
      message: "Orden #TS-2024-002 marcada como completada",
    ...
    },
    {
      id: 3,
      type: "new_client",
      message: "Nuevo cliente registrado: Carlos Rodríguez",
      time: "Hace 1 hora",
      icon: "user",
    },
    {
      id: 4,
      type: "payment",
      message: "Pago recibido para orden #TS-2024-003 - $150.00",
      time: "Hace 2 horas",
      icon: "dollar",
    },
  ] as ActivityItem[],
...
export const testAdminSidebarItems = [
  {
    title: "Dashboard",
