...
const adminSidebarItems = [
  ...
  },
  {
    ...
    href: "/test/dashboard/admin/orders",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    href: "/test/dashboard/admin/users",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  {
    title: "Clientes",
    href: "/test/dashboard/admin/clients",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  {
    title: "Reportes",
    href: "/test/dashboard/admin/reports",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
...
export default function TestAdminDashboard() {
  ...
  const mockRecentActivity = [
    { id: 1, action: "Nueva orden creada", client: "Juan Pérez", time: "Hace 5 min" },
    { id: 2, action: "Orden completada", client: "María García", time: "Hace 15 min" },
    { id: 3, action: "Técnico asignado", client: "Carlos López", time: "Hace 30 min" },
    { id: 4, action: "Cliente registrado", client: "Ana Martínez", time: "Hace 1 hora" },
  ]
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Vista general del sistema de servicio técnico</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatsCard
            title="Técnicos"
            value={mockStats.totalTechnicians}
            icon={
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Cliente: {activity.client}</p>
                    </div>
                  </div>
